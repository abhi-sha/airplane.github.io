...
class d_book //class  for domestic booking
{
public:
    int pnr;
...
void d_pnr()
    ...
    int j_detail() // function declaration and definition for domestic journey
    {
        ...
        cin >> date;
        cout << "\n 1.DELHI    2.KOLKATA     3.CHENNAI    4.MUMBAI    " << endl << endl;
        ...
        else if((src==1 && dest==4) || (src==4 && dest==1))//condition
        {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.AIR INDIA\t08:00\t\t11:05\t\tRs.4000\t\tRefundable\n";
            cout << "\2.INDIGO\t14:00\t\t17:05\t\tRs.4250\t\tRefundable\n";
        ...
        else if((src==2 && dest==3) || (src==3 && dest==2))//condition
        {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.AIR INDIA\t08:00\t\t11:05\t\tRs.5400\t\tRefundable\n";
            cout << "\2.INDIGO\t14:00\t\t17:05\t\tRs.2500\t\tRefundable\n";
        ...
        else if((src==2 && dest==4) || (src==4 && dest==2))//condition
        {
            ...
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.AIR INDIA\t08:00\t\t11:05\t\tRs.5000\t\tRefundable\n";
            cout << "\2.INDIGO\t14:00\t\t17:05\t\tRs.4500\t\tRefundable\n";
            cout << "\3.VISTARA\t19:00\t\t22:05\t\tRs.6000\t\tRefundable\n";
        }
        else if((src==3 && dest==4) || (src==4 && dest==3))//condition
        {
            cout << "\t \t \tFlights Found" << endl << endl;
            cout << "Airline:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\1.AIR INDIA\t08:00\t\t11:05\t\tRs.5800\t\tRefundable\n";
            cout << "\2.INDIGO\t14:00\t\t17:05\t\tRs.5508\t\tRefundable\n";
    ...
    int  select_flight() //function declaration and definition for selecting flight
    {
        ...
        case 3://condition
            cout << "\nFlight selected:" << endl;
            cout << "VISTARA" << endl;
            strcpy(f_d,"VISTARA");//copy to string
...
class i_book//class for international booking
{
...
public://public member functions
    ...
    int j_detaili()// function declaration and definition for journey details
    {
        ...
        cin >> datei;
        cout << "\n 1.LONDON     2.DUBAI     3.AUSTRALIA     4.CANADA     5.NEW YORK "<< endl << endl;
        cout << "\tEnter Source" << endl;
        cin >> srci;
        cout << "\nEnter destination" ;
        cin >> desti;
        ...
        {
            cout << "AIRLINE:\tDeparture:\tArrival:\tPrice:\t\tCategory:\n";
            cout << "\n1.AIR ASIA   10:00   14:05   Rs.25000   Refundable\n";
            cout << "\n2.EMIRATES   14:00   18:05   Rs.21500   Refundable\n";
            cout << "\n3.AIR INDIA   18:00   22:05   Rs.24000   Refundable\n";
        }
...
class passenger: public d_book,public i_book//class passenger publicly inherited from class d_bookand i_book
{
...
public://public members functions
    void pay_detail()//function declaration and definition for payment method
    {
        ...
        case 2://condition
            ...
            break;
        case 3://condition
            cout << "Banks Available:  1.HDFC BANK   2.ICIC BANK   3.SBI    4.OTHERS\n";
            cout << "\nSelect your bank:";
            cin >> bank;
...
int main()//main function
{
    ...
    class d_bookd1;//object for class d_booking
    class i_book i1;//object for class i_book
